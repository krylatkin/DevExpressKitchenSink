...
(function() {
    ...
    var gallery = [
            { src: "url(content/images/gallery/boats.jpg)" },
            { src: "url(content/images/gallery/cherry.jpg)" },
            { src: "url(content/images/gallery/country.jpg)" },
            { src: "url(content/images/gallery/field.jpg)" },
            { src: "url(content/images/gallery/headphone.jpg)" },
            { src: "url(content/images/gallery/keyboard.jpg)" },
            { src: "url(content/images/gallery/ny.jpg)" },
            { src: "url(content/images/gallery/orange.jpg)" },
            { src: "url(content/images/gallery/palms.jpg)" },
            { src: "url(content/images/gallery/sunrise.jpg)" },
            { src: "url(content/images/gallery/sunset.jpg)" },
            { src: "url(content/images/gallery/town.jpg)" }
    ];
